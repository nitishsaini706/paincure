...
<Container >
        ...
        <Navbar.Collapse className="ml-28" id="basic-navbar-nav">
          <Nav className="me-auto">
            ...
            <NavDropdown title="Services" menuVariant={color} id="nav-dropdown" className={`text-${color} bg-${bg}`} >
          ...
          <Navbar.Text>
            <Button type="submit" className={`${bg === 'white' ? `text-black border-1 border-solid border-black bg-white` : `text-white border-1 border-solid border-white bg-black`} px-3 mx-2 rounded-2xl`}>Login</Button>
